    ...
    <div>
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
          ...
          <Link href={'/product/fashion-meets-comfort'} > <div class="md:w-1/2 p-4 w-full cursor-pointer shadow-lg m-1">
            ...
            <Link href={'/product/fashion-meets-comfort'} > <div class="md:w-1/2 p-4 w-full cursor-pointer shadow-lg m-5">
              <a class="block relative  rounded overflow-hidden">
                <img
                  alt="ecommerce"
