  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">HoodieHub.Com</h2>
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">Order Id: #945509580</h1>
        ...
        <div class="flex flex-col">
          ...
          <div className='my-6'>
          <button class="flex mx-0 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Track Order</button>
          </div>
