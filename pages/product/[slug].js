            ...
            />
              ...
              <div class="flex">
                ...
                <button
                  ...
                  class="flex ml-4 text-white bg-indigo-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-indigo-600 rounded"
                >
                  Buy Now
                </button>
              ...
              <div className="pin mt-6 flex space-x-2 text-sm">
                <input
                  ...
                  className="px-2 border-2 border-indigo-400 rounded-md"
                  type="text"
