...
export default function Home() {
  return (
    <div>
      ...
      <div>
      <video src="/mac.webm" width={5000} height={2000} autoPlay loop style={{ border: '2px solid #ccc', borderRadius: '8px' }} />
      </div>
      <section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900"> HoodieHub.Com</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Your Ultimate Destination for Stylish and Cozy Hoodies.</p>
    </div>
