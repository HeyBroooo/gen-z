        ...
        <div class="container px-5 py-24 mx-auto">
          ...
          <div class="flex flex-wrap -m-4">
            <div class="xl:w-1/3 md:w-1/2 p-4">
              <div class="border border-gray-200 p-6 rounded-lg hover:scale-110 hover:-translate-y-1 transition ease-in-out delay-150">
      ...
      <div>
        <section class="text-gray-600 body-font">
          <div class="container px-5 py-24 mx-auto">
            ...
            <button class="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg hover:scale-110 hover:-translate-y-1 transition ease-in-out delay-150">
              Button
            </button>
          </div>
        </section>
